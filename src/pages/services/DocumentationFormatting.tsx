...
import { FileText, Edit, BookOpen, Layout } from "lucide-react";
import { Link } from "react-router-dom";
import { useEffect } from "react";

const DocumentationFormatting = () => {
  useEffect(() => {
    document.title = "Documentation & Formatting | ThinkCraft";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "We refine your work to align with global academic and business standards. Professional formatting in APA, MLA, IEEE, Chicago, and more.");
    }
  }, []);

  const features = [
    { icon: FileText, title: "Formatting in APA, MLA, IEEE, Chicago, and more", description: "Expert formatting to meet any academic or business style guide requirements." },
    { icon: Edit, title: "Grammar & Style Editing", description: "Comprehensive editing to ensure clarity, correctness, and professional tone." },
    { icon: BookOpen, title: "Reference and Citation Management", description: "Proper citation formatting and reference list management for all style guides." },
    { icon: Layout, title: "Document Structuring & Template Design", description: "Professional document structure and custom templates tailored to your needs." }
  ];
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          >
            <h1 className="text-heading-1 md:text-heading-1 font-bold mb-6" style={{ color: '#092c5d' }}>
              Professional Formatting that Commands Attention
            </h1>
            ...
            >
              <img 
                src="/images/digital-marketer.jpg" 
                alt="Documentation and Formatting" 
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-center mb-8 max-w-3xl mx-auto leading-snug"
              style={{ color: '#092c5d'}}>
              Professional formatting that meets global standards
            </h2>
            ...
            >
              <p className="text-body mb-4 leading-relaxed text-justify" style={{ color: '#092c5d' }}>
                We refine your work to align with global academic and business standards. Whether you're submitting a university report or a company proposal, we make sure it looks polished, credible, and compliant with any required formatting style.
              </p>
              <p className="text-body leading-relaxed text-justify" style={{ color: '#092c5d' }}>
                We turn raw drafts into professional-grade documents ready for presentation or submission.
              </p>
            </motion.div>
          ...
          >
            <p className="text-body mb-8 font-medium" style={{ color: '#092c5d', opacity: 0.9 }}>
              Ready to transform your document into a professional-grade submission?
            </p>
...
export default DocumentationFormatting;
